...
import { 
  LayoutTemplate, Palette, Ticket, Clock, CreditCard, 
  Users, ArrowRight, Check, ChevronRight, Star, Calendar,
  Globe, Shield, Zap
} from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-blue-600/10 to-sky-500/10 rounded-2xl transform -rotate-2"></div>
                <img 
              ...
              <div className="absolute -bottom-10 -right-10 bg-white p-4 rounded-lg shadow-lg flex items-center gap-3 animate-float">
              ...
              <div className="absolute -top-10 -left-10 bg-white p-4 rounded-lg shadow-lg flex items-center gap-3 animate-float" style={{ animationDelay: "1s" }}>
                    ...
                    <Card className="border-none shadow-md bg-gradient-to-br from-white to-blue-50">
                      <CardContent className="p-8">
                        <div className="flex flex-col items-center text-center">
                          ...
                          <blockquote className="text-2xl font-medium mb-4 text-gray-800">"{testimonial.quote}"</blockquote>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            >
              <div className="p-6">
                ...
                <Button variant="outline" className="w-full border-gray-300 text-gray-700 hover:bg-gray-50">Contact Sales</Button>
              </div>
            </div>
          </div>
        </div>
